...
<div class="form-group row">
    <div class="col-md-4">
        ...
        {!! Form::number('quantity', null, ['class' => 'form-control', 'id' => 'detail-quantity', 'step' => 'any' , 'required' => true , 'maxlength' => '18', 'min' => '0', 'oninput' => "if(this.value.length > this.maxLength){this.value = this.value.slice(0, this.maxLength)}
        if(this.value<0){this.value='0'}"]) !!}
    </div>
    <div class="col-md-4">
    ...
    @if($bc == 'BC23')
        <div class="col-md-4">
            ...
            {!! Form::number('details[harga_barang]', 0, ['class' => 'form-control', 'id' => 'detail-amount', 'required' => true , 'step' => 'any' ,  'maxlength' => '18', 'min' => '0', 'oninput' => "if(this.value.length > this.maxLength){this.value = this.value.slice(0, this.maxLength)}
            if(this.value<0){this.value='0'}" ]) !!}
        </div>
    @else
        <div class="col-md-4">            
            ...
            {!! Form::number('details[harga_penyerahan]', 0, ['class' => 'form-control', 'id' => 'detail-amount', 'required' => true , 'step' => 'any',  'maxlength' => '18', 'min' => '0', 'oninput' => "if(this.value.length > this.maxLength){this.value = this.value.slice(0, this.maxLength)}
            if(this.value<0){this.value='0'}" ]) !!}
        </div>
    @endif
</div>
...
<div class="form-group row" style="margin-top: 10px;">
    ...
    <div class="col-md-4">
        ...
        {!! Form::number('details[fob]', 0, ['class' => 'form-control bg-secondary', 'id' => 'detail-fob', 'required' => true , 'step' => 'any' , 'readonly' ,  'maxlength' => '18', 'min' => '0', 'oninput' => "if(this.value.length > this.maxLength){this.value = this.value.slice(0, this.maxLength)}
        if(this.value<0){this.value='0'}" ]) !!}
    </div>
</div>
@endif
...
<div class="form-group row" style="margin-top: 10px;">
    <div class="col-md-4">
        ...
        {!! Form::number('details[harga_satuan]', 0, ['class' => 'form-control bg-secondary', 'id' => 'detail-harga-satuan', 'required' => true , 'step' => 'any' , 'readonly' , 'maxlength' => '18', 'min' => '0', 'oninput' => "if(this.value.length > this.maxLength){this.value = this.value.slice(0, this.maxLength)}
        if(this.value<0){this.value='0'}" ]) !!}
    </div>
    <div class="col-md-4">

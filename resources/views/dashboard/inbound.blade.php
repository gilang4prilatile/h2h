                        ...
                        <div class="card-body pt-9 pb-0">
                                            ...
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div class="border border-gray-300 border-dashed rounded min-w-40px py-3 px-4 me-6 mb-3">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{ $inboundsOpen }}" >0</div>
                                                    </div>
                                                    <!--end::Number-->
                                                    <!--begin::Label-->
                                                    <div class="fw-bold fs-6 text-gray-400">Inbound Open</div>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Stat-->
                                                <!--begin::Stat-->
                                                <div class="border border-gray-300 border-dashed rounded min-w-40px py-3 px-4 me-6 mb-3">
                                                    <!--begin::Number-->
                                                    <div class="d-flex align-items-center">
                                                        <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{ $inboundsClose }}" >0</div>
                                                    </div>
                                                    <!--end::Number-->
                                                    <!--begin::Label-->
                                                    <div class="fw-bold fs-6 text-gray-400">Inbound Close</div>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Stat-->
                                            </div>
                            ...
                            <div class="d-flex overflow-auto h-55px">
                                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary me-6 active" href="/dashboard/inbound">Inbound</a>
                                    </li>
                                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
    ...
    $(document).ready(function(){
        ...
        function initChartInbound1() {
            ...
            let getDataChart1Ajax = (year) => {
                ...
                $.ajax({
                    url : `/dashboard/data-inbound-chart-ajax/${year}`,
                    method : 'GET',
                    success : function(res){

                        let perMonthInboundDone = $.each(res.perMonthInboundDone, (i, vi) => {return vi});
                        let perMonthInboundDraft = $.each(res.perMonthInboundDraft, (i, vi) => {return vi});                
                        chart.updateSeries([
                            {
                                name : 'Open',
                                data : perMonthInboundDraft
                            },
                            {
                                name : 'Close',
                                data : perMonthInboundDone
                            }
                        ]);      
        ...
        function initChartInbound2() {
            ...
            let getDataChart2Ajax = (year) => {
                ...
                $.ajax({
                    url : `/dashboard/data-inbound-quantity-chart-ajax/${year}`,
                    method : 'GET',
                    success : function(res){

                        perMonthBC40 = $.each(res.perMonthBC40, (i, vi) => {return vi});
                        perMonthBC23 = $.each(res.perMonthBC23, (i, vi) => {return vi});                
        ...
        function initChartInbound3() {
            ...
            let getDataChart3Ajax = (year) => {
                ...
                $.ajax({
                    url : `/dashboard/data-inbound-top-goods-chart-ajax/${year}`,
                    method : 'GET',
                    success : function(res){

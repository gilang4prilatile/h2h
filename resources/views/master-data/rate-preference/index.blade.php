                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                    ...
                                    <!--begin::Input group-->
                                    <div class="mb-10">
                                        <label class="form-label fs-6 fw-bold">Regulasi</label>
                                        {!! Form::text('regulation', null, ['class' => 'form-control form-control-lg form-control-solid']) !!}
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Actions-->
                            ...
                            <!--end::Filter-->
                            <!--begin::Add user-->
                            @can('create master-data rate-preference')
                            <x-link-add-new />
                            @endcan
                            <!--end::Add user-->
                        </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Regulasi</th>
                                <th class="min-w-125px">Tanggal Berlaku</th>
                                <th class="min-w-125px">Biaya Masuk</th>

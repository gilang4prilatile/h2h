            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ $mainUrl }}" class="text-muted text-hover-primary">Bank</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
            ...
            <div id="kt_content_container" class="container">
                ...
                <div class="card">
                    <div class="py-10">
                        ...
                        <div class="p-10">
                            {{-- <div class="mb-10">
                                <label class="form-label required">No Seri</label>
                                {!! Form::text('no_seri', null, ['class' => 'form-control']) !!}
                            </div> --}}
                            <div class="mb-10">
...
@push('js')
    {!! JsValidator::formRequest('App\Http\Requests\MasterData\BankRequest', '#form') !!}
@endpush

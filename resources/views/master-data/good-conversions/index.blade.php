...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="javascript::void();" class="text-muted text-hover-primary">Good Conversions</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ url('master-data/good-conversions') }}" class="text-muted text-hover-primary">Master Data</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-400px w-md-500px ms-20" data-kt-menu="true">
                                ...
                                <!--end::Separator-->
                                <!--begin::Content-->
                                <form action="master-data/good-conversions/filter" method="GET">
                                    @csrf
                            ...
                            <!--end::Filter-->
                            <!--begin::Add user-->
                            @can('create master-data good-conversion')
                            <a href="{{url('master-data/good-conversions/create')}}" type="button" class="btn btn-primary sm">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Nett Weight</th>
                                <th class="min-w-125px">Detail Goods</th>
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>{{$row->name}}</td>
                                <td>{{floatVal($row->nett_weight)}}</td>
                                <td>
                                    <button class="btn btn-light-success sm" onclick="detailGoods({{ $row->id }})">Detail Goods</button>
                                </td>
                                <td>
                                    @can('edit master-data goods')
                                    <a href="{{url('master-data/good-conversions/update')}}/{{$row->id}}" type="button" class="btn btn-light-warning btn-sm fas fa-edit fs-4">
                                    </a>
                                    @endcan
                                    @can('delete master-data goods')
                                    <a href="{{url('master-data/good-conversions/delete')}}/{{$row->id}}" type="button" class="btn btn-light-danger btn-sm fas fa-trash-alt fs-4">
                                    </a>
                                    @endcan
                                </td>
                            </tr>
            ...
            <!--end::Card-->
            @include('master-data.good-conversions.modal')
        </div>
        <!--end::Container-->
    </div>
    <!--end::Post-->
...
<script>
    ...
    function detailGoods(id) {
        ...
        $.ajax({
            'method': 'GET',
            'url': `/master-data/good-conversions/good-conversion-by-id-ajax/${id}`,
            'success': function(res) {
                dataDetailGoods = $.each(res.data, (i, vi) => {
                    return vi
                });

                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                    <!--begin::Input group-->
                                    <div class="mb-10">
                                        <label class="form-label fs-6 fw-bold">Code Office</label>
                                        {!! Form::text('code_office', null, ['class' => 'form-control form-control-lg form-control-solid']) !!}
                                    </div>
                                    <!--end::Input group-->

                                    <!--begin::Input group-->
                                    <div class="mb-10">
                                        <label class="form-label fs-6 fw-bold">Code Warehouse</label>
                                        {!! Form::text('code_warehouse', null, ['class' => 'form-control form-control-lg form-control-solid']) !!}
                                    </div>
                                    <!--end::Input group-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Code Office</th>
                                <th class="min-w-125px">Code Warehouse</th>

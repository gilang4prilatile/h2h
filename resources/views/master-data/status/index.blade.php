        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Status</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ $mainUrl }}" class="text-muted text-hover-primary">Status</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                    ...
                                    <div class="px-7 py-5" data-kt-user-table-filter="form">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            {!! Form::text('nama', null, ['class' => 'form-control form-control-lg form-control-solid']) !!}
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Actions-->
    ...
    <script>
        $(document).ready(function() {
            var table = $('#table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('master-data/status/data') }}",
                    data: function(d) {

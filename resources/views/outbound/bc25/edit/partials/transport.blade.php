<div class="form-group row" style="margin-top:10px;">
    ...
    <div class="col-md-6">
        ...
        {!! Form::select('details[transport_line_id]', $transportLines, $outbound->outboundTransportLine->transport_line_id, ['class' => 'form-select', 'required' => true, 'data-control' => 'select2', 'placeholder' => '-- Select --']) !!}

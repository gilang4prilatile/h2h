            ...
            <div id="kt_content_container" class="container">
                ...
                <div class="card ">
                    <div class="card-header card-header-stretch">
                        <h3 class="card-title">Edit BC41</h3>
                        ...
                        <div class="form-group">
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    {!! Form::text('request_number', $outbound->request_number, ['class' => 'form-control ', 'required' => true, 'placeholder' => 'Input No Pengajuan', 'id' => 'request_number']) !!}
                                ...
                                <div class="col-md-4">
                                    ...
                                    {!! Form::text('details[nomor_pendaftaran]', @$outbound->details['nomor_pendaftaran'] ?: null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Input No Pendaftaran', 'id' => 'nomor_pendaftaran']) !!}
                            ...
                            <div class="form-group row" style="margin-top:10px;">
                                ...
                                <div class="col-md-6 ">
                                    <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey ">
                                        ...
                                        {!! Form::select('pengirim_barang_id', $pengirimBarangSelectBox, $outbound->outboundPengirimBarang->profile_id ?? '', [ 'class' => 'form-select', 'required' => true, 'data-control' => 'select2', 'placeholder' => '-- Select --' ,'id'=>'pengirim_barang_id']) !!}
                            ...
                            <div class="form-group row" style="margin-top:10px;">
                                ...
                                <div class="col-md-4">
                                    ...
                                    {!! Form::select('transportation_id', $transportations, @$outbound->outboundTransportation->transportation->id ?: null, ['class' => 'form-select', 'required' => true, 'data-control' => 'select2', 'placeholder' => '-- Select --']) !!}
                                ...
                                <div class="col-md-4">
                                    ...
                                    {!! Form::text('vehicle_number', @$outbound->outboundTransportation->vehicle_number ?: null, ['class' => 'form-control', 'required' => true , 'maxlength' => 20]) !!}
                            ...
                            <div class="form-group row" style="margin-top:10px;">
                                <div class="col-md-3">
                                    ...
                                    {!! Form::number('details[harga_penyerahan]', @$outbound->details['harga_penyerahan'] ?: 0, ['class' => 'form-control bg-secondary', 'required' => true, 'placeholder' => 'Input Harga Penyerahan' , 'id' => 'harga_penyerahan' , 'readonly',  'step' => 'any']) !!}
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::number('details[volume]', @$outbound->details['volume'] ?: 0, ['class' => 'form-control bg-secondary', 'required' => true, 'placeholder' => 'Input' , 'readonly' , 'id' => 'total_volume',  'step' => 'any']) !!}
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::number('details[berat_kotor]', @$outbound->details['berat_kotor'] ?: 0, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Input' , 'id' => 'berat_kotor',  'step' => 'any']) !!}
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::number('details[berat_bersih]', @$outbound->details['berat_bersih'] ?: 0, ['class' => 'form-control bg-secondary', 'required' => true, 'placeholder' => 'Input' , 'readonly' , 'id' => 'berat_bersih',  'step' => 'any']) !!}

                ...
                <div class="card-header card-header-stretch">
                    ...
                    <div class="card-toolbar mt-5">
                        <div class="float-right">
                            <a href="{{ $mainUrl.'/detail/'.$id }}" id="" class="btn btn-light me-3 mb-5"><i class="fas fa-chevron-left"></i> Kembali</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            @foreach ($datapartial as $datapartial)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="outbound/bc-41/detail/partial/{{ $datapartial->id }}/{{ $datapartial->Sku_Barang }}/delete" class="btn btn-sm btn-light-danger delete-button fas fa-trash-alt {{ $datapartial->status != 1 ? '' : 'disabled' }}"> Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                    ...
                    <form method="POST" action="outbound/bc-41/detail/partial/{{ $id }}/{{ $sku }}/create">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
            ...
            Swal.fire({
                ...
                cancelButtonText : 'Batal',
                    ...
                    if(result.isConfirmed){
                        window.location.href = `outbound/bc-41/detail/partial/${id}/${skuBarang}/sppd`;
                    }
            })

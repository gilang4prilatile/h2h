                        ...
                        <div class="form-group">
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    {!! Form::text('request_number', null, ['class' => 'form-control ', 'required' => true, 'placeholder' => 'Input No Pengajuan']) !!}
                                ...
                                <div class="col-md-4">
                                    ...
                                    {!! Form::text('details[nomor_pendaftaran]', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Input No Pendaftaran']) !!}
                            ...
                            <div class="form-group row" style="margin-top:10px;">
                                <div class="col-md-6">
                                    ...
                                    {!! Form::select('kppbc_asal_id', $kppbcSelectBox, null, ['class' => 'form-select', 'required' => true, 'placeholder' => '-- Select --', 'data-control' => 'select2']) !!}
                                ...
                                <div class="col-md-6">
                                    ...
                                    {!! Form::select('kppbc_tujuan_id', $kppbcSelectBox, null, ['class' => 'form-select', 'required' => true, 'placeholder' => '-- Select --', 'data-control' => 'select2']) !!}
                            ...
                            <div class="form-group row" style="margin-top:10px;">
                                <div class="col-md-6">
                                    ...
                                    {!! Form::select('jenis_tpb_asal_id', $jenisTpbSelectBox, null, ['class' => 'form-select', 'required' => true, 'data-control' => 'select2', 'placeholder' => '-- Select --']) !!}
                                ...
                                <div class="col-md-6">
                                    ...
                                    {!! Form::select('jenis_tpb_tujuan_id', $jenisTpbSelectBox, null, ['class' => 'form-select', 'required' => true, 'data-control' => 'select2', 'placeholder' => '-- Select --']) !!}
                            ...
                            <div class="form-group row" style="margin-top:10px;">
                                <div class="col-md-4">
                                    ...
                                    {!! Form::select('tpb_asal_id', $tpbSelectBox, null, ['class' => 'form-select', 'required' => true, 'data-control' => 'select2', 'placeholder' => '-- Select --']) !!}
                                ...
                                <div class="col-md-4">
                                    ...
                                    {!! Form::select('tpb_tujuan_id', $tpbSelectBox, null, ['class' => 'form-select', 'required' => true, 'data-control' => 'select2', 'placeholder' => '-- Select --']) !!}
                            ...
                            <div class="form-group row" style="margin-top:10px;">
                                <div class="col-md-4">
                                    ...
                                    {!! Form::select('valas_id', $valas, null, ['class' => 'form-select', 'required' => true, 'placeholder' => '-- Select --', 'data-control' => 'select2']) !!}
                                ...
                                <div class="col-md-4">
                                    ...
                                    {!! Form::number('details[cif]', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Input', 'id' => 'cif']) !!}
                                ...
                                <div class="col-md-4">
                                    ...
                                    {!! Form::number('details[harga_penyerahan]', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Input Harga Penyerahan']) !!}
                            ...
                            <div class="form-group row" style="margin-top:10px;">
                                ...
                                <div class="col-md-4">
                                    ...
                                    {!! Form::text('details[nomor_peti_kemas]', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Input', 'id' => 'nomor_peti_kemas']) !!}
                                ...
                                <div class="col-md-4">
                                    ...
                                    {!! Form::number('details[ukuran_peti_kemas]', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Input', 'id' => 'ukuran_peti_kemas']) !!}
                                ...
                                <div class="col-md-4">
                                    ...
                                    {!! Form::select('details[tipe_peti_kemas]', $containers, null, ['class' => 'form-select', 'required' => true, 'placeholder' => '-- Select --', 'data-control' => 'select2']) !!}
                            ...
                            <div class="form-group row" style="margin-top:10px;">
                                <div class="col-md-6">
                                    ...
                                    {!! Form::number('details[volume]', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Input', 'id' => 'total_volume']) !!}
                                ...
                                <div class="col-md-6">
                                    ...
                                    {!! Form::number('details[berat_kotor]', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Input', 'id' => 'berat_kotor']) !!}
                            ...
                            <div class="form-group row" style="margin-top:10px;">
                                <div class="col-md-6">
                                    ...
                                    {!! Form::number('details[berat_bersih]', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Input', 'id' => 'berat_bersih', 'readonly']) !!}
                            ...
                            <div class="form-group">
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        {!! Form::text('details[pabean_tempat]', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Input Nama']) !!}
                            ...
                            <div class="form-group mt-4">
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        {!! Form::text('details[pabean_pemberitahu]', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Input Pemberi Tahu']) !!}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        {!! Form::text('details[pabean_jabatan]', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Input Jabatan']) !!}

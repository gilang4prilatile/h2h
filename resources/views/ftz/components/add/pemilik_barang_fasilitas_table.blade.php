    ...
    $(document).ready(function() {
        var table = $('#table-pemilik-barang').DataTable({
            ...
            columns: [
                ...
                {
                    data: 'pemilik_barang_indentitas_nomor',
                    name: 'pemilik_barang_indentitas_nomor',
                    defaultContent: '',
                },
                {
                    data: 'pemilik_barang_alamat',
                    name: 'pemilik_barang_alamat',
                    defaultContent: '',
                },
                {
                    data: 'pemilik_barang_nama',
                    name: 'pemilik_barang_nama',
                    defaultContent: '',
                },
                {
                    data: 'actions',

                    ...
                    <div class="col-md-6">
                        <div class="d-flex">
                            ...
                            <div class="d-flex d-none" id='opsi-lartas'> 
                                <i class="fas fa-exclamation-circle me-2" id="status_icon" style="color:red;"></i>
                                <p class="status-lartas" readonly='readonly' id='status_lartas'></p>
                            </div>
                        </div>
            ...
            $('#add-modal').on('show.bs.modal', function(e) {
                ...
                && bc == 'BC30') {
                    ...
                    $.each(banyakPemilikBarang, function(i, vl1){
                        if(vl1.good_facility != undefined)
                            $.each(vl1.good_facility, function(i , vl2){
                                if(vl2 == selectedGood.good_id){
                                    $('#entitas_barang_id').val(vl1.pemilik_id).trigger('change');
                                    $('#entitas_barang_id').attr('disabled', true);
                                }
                            });
                    });

                    $('#entitas_barang').show();
                }else if(Object.keys(selectedGood).length !== 0) {

...
@section('content')
    @include("components.toolbar", ['parentMenuName' => 'FTZ0101', 'menuName' => 'FTZ Import From Outside Pabean'])
    <!--begin::Content-->
            ...
            <div id="kt_content_container" class="container">
                ...
                <div class="card ">
                    <div class="card-header card-header-stretch">
                        <h3 class="card-title">Detail FTZ0101, Nomor Pengajuan : {{$inbound->request_number}}</h3>

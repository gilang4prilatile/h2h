<div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey; margin-top:10px; ">
    ...
    <div class="form-group row" style="margin-top:10px;"> 
        ...
        <div class="col-md-2">
            ...
            {!! Form::text('details[estimated_arrival_date]', @$inbound->details['estimated_arrival_date'] ?: null, ['class' => 'form-control datepicker', 'required' => true, 'placeholder' => 'input Tanggal', 'id' => 'estimated_arrival_date']) !!}

    ...
    <div class="toolbar" id="kt_toolbar"> 
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack"> 
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">FTZ Import From Outside Pabean</h1>
            ...
            <div id="kt_content_container" class="container">
                ...
                <div class="card "> 
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                                ...
                                <div  class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey;  margin-top:10px; ">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            {!! Form::text('details[tanggal_pendaftaran]', $tanggalHariIni, ['class' => 'form-control datepicker', 'required' => true, 'placeholder' => 'Pilih Tanggal']) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4" style="margin-top:10px;">
                                            <label class="form-label required">Kategori Pemberitahuan</label>
                                        ...
                                        <div class="col-md-4" style="margin-top:10px;">
                                            <label class="form-label required">Kategori Pemasukan</label>
                                            {!! Form::select('expenditure_destination_id', $MasterExpenditureDestination, null, ['class' => 'form-select', 'required' => true, 'placeholder' => '-- Select --', 'data-control' => 'select2']) !!}
                                            @if($errors->has('expenditure_destination_id'))
                                                <span class="error text-danger">{{ $errors->first('expenditure_destination_id') }}</span>
                                            @endif
                                        </div> 
                                    </div>
                                    ...
                                    <div class="form-group row">  
                                        <div class="col-md-4" style="margin-top:10px;">
                                            <label class="form-label required">Tujuan Pemasukan</label>
                                            {!! Form::select('income_purpose_ftz_id', $MasterIncomePurpose, null, ['class' => 'form-select', 'required' => true, 'placeholder' => '-- Select --', 'data-control' => 'select2']) !!}
                                            @if($errors->has('income_purpose_ftz_id'))
                                                <span class="error text-danger">{{ $errors->first('income_purpose_ftz_id') }}</span>
                                            @endif
                                        </div>
                                        <div class="col-md-4" style="margin-top:10px;">
                                            <label class="form-label required">Asal Barang</label>
                                            {!! Form::select('origin_of_goods_ftz_id', $MasterOriginOfGood, null, ['class' => 'form-select', 'required' => true, 'data-control' => 'select2']) !!}
                                            @if($errors->has('origin_of_goods_ftz_id'))
                                                <span class="error text-danger">{{ $errors->first('origin_of_goods_ftz_id') }}</span>
                                            @endif
                                        </div>
                                        <div class="col-md-4" style="margin-top:10px;">
                                            <label class="form-label required">Kategori Barang</label>
                                            {!! Form::select('good_category_id', $MasterGoodCategory, null, ['class' => 'form-select', 'required' => true, 'data-control' => 'select2']) !!}
                                            @if($errors->has('good_category_id'))
                                                <span class="error text-danger">{{ $errors->first('good_category_id') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4 bg-transparent border-dashed border-1  rounded p-3" style="margin-bottom:10px;">
                                            <h2 class="fw-bolder mt-4"> <label class="form-label "><b>Importir</b></label></h2>
                                                ...
                                                <div class="form-group row" id="importir_input" name="importir_input">
                                                    <div class="col-md-12"> 
                                                        {!! Form::select('importir_indentitas_type', $jenisIdentitas, $user_customer ?? '', ['class' => 'form-select', 'data-control' => 'select2', 'placeholder' => 'Jenis','id'=>'importir_indentitas_type']) !!}
                                                    </div>
                                                    <div class="col-md-12"> 
                                                        {!! Form::text('importir_indentitas_nomor',null, ['class' => 'form-control', 'id' => 'importir_indentitas_nomor', 'placeholder' => 'No Indentitas','oninput' => 'this.value = this.value.toUpperCase()', 'maxlength' => '25']) !!}
                                                    </div>
                                                    <div class="col-md-12"> 
                                                    ...
                                                    <div class="col-md-12"> 
                                                        {!! Form::textarea('importir_alamat', null, ['class' => 'form-control','placeholder' => 'Alamat', 'id' => 'importir_alamat', 'style' => 'height: 10px;']) !!}
                                                    </div>
                                                    <div class="col-md-4"> 
                                        ...
                                        <div class="col-md-4 bg-transparent border-dashed border-1 rounded p-3" style="margin-bottom:10px;">
                                            <h2 class="fw-bolder mt-4"> 
                                                ...
                                                <div class="form-group row" id="pemilik_barang_input" name="pemilik_barang_input">
                                                    <div class="col-md-12"> 
                                                        {!! Form::select('pemilik_indentitas_type', $jenisIdentitas, $user_customer ?? '', ['class' => 'form-select',  'data-control' => 'select2', 'placeholder' => 'Jenis','id'=>'pemilik_indentitas_type']) !!}
                                                    </div>
                                                    <div class="col-md-12"> 
                                                        {!! Form::text('pemilik_indentitas_nomor',null, ['class' => 'form-control','id'=>'pemilik_indentitas_nomor', 'placeholder' => 'No Indentitas','oninput' => 'this.value = this.value.toUpperCase()', 'maxlength' => '25']) !!}
                                                    </div>
                                                    <div class="col-md-12"> 
                                                    ...
                                                    <div class="col-md-12">
                                                        {!! Form::textarea('pemilik_alamat', null, ['class' => 'form-control', 'placeholder' => 'Alamat','id' => 'pemilik_alamat', 'style' => 'height: 10px;']) !!}
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-4 bg-transparent border-dashed border-1  rounded p-3" style="margin-bottom:10px;">
                                          <h2 class="fw-bolder mt-4"> 
                                                ...
                                                <div class="form-group row" id="pemusatan_input" name="pemusatan_input">
                                                    <div class="col-md-12"> 
                                                        {!! Form::select('pemusatan_indentitas_type', $jenisIdentitas, $user_customer ?? '', ['class' => 'form-select', 'data-control' => 'select2', 'placeholder' => 'Jenis Identitas','id'=>'pemusatan_indentitas_type']) !!}
                                                    </div> <br>
                                                    <div class="col-md-12"> 
                                                        {!! Form::text('pemusatan_indentitas_nomor',null, ['class' => 'form-control', 'placeholder' => 'No Identitas', 'id' => 'pemusatan_indentitas_nomor','oninput' => 'this.value = this.value.toUpperCase()', 'maxlength' => '25']) !!}
                                                    </div> <br>
                                                    <div class="col-md-12"> 
                                                    ...
                                                    <div class="col-md-12"> 
                                                        {!! Form::textarea('pemusatan_alamat', null, ['class' => 'form-control', 'placeholder' => 'Alamat', 'id' => 'pemusatan_alamat', 'style' => 'height: 10px;']) !!}
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-4 bg-transparent border-dashed border-1  rounded p-3" style="margin-bottom:10px;">
                                            <h2 class="fw-bolder mt-4"> 
                                                ...
                                                <div class="form-group row" id="pengirim_barang_input"> 
                                                    <div class="col-md-12"> 
                                                        {!! Form::text('pengirim_nama',null, ['class' => 'form-control', 'placeholder' => 'Nama','oninput' => 'this.value = this.value.toUpperCase()', 'maxlength' => '100']) !!}
                                                    </div>
                                                    <div class="col-md-12"> 
                                                        {!! Form::textarea('pengirim_alamat', null, ['class' => 'form-control', 'placeholder' => 'Alamat', 'id' => 'pengirim_alamat', 'style' => 'height: 10px;']) !!}
                                                    </div>
                                                    <div class="col-md-12"> 
                                        ...
                                        <div class="col-md-4 bg-transparent border-dashed border-1  rounded p-3" style="margin-bottom:10px;">
                                            ...
                                            <div class="form-group row" id="penjual_barang_input" name="penjual_barang_input"> 
                                                ...
                                                <div class="col-md-12"> 
                                                    {!! Form::textarea('penjual_alamat', null, ['class' => 'form-control', 'placeholder' => 'Alamat','id' => 'penjual_alamat', 'style' => 'height: 10px;']) !!}
                                                </div>
                                                <div class="col-md-12"> 
                            ...
                            <div class="tab-pane fade" id="nav-dokumen" role="tabpanel" aria-labelledby="nav-dokumen-tab">
                                ...
                                <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey;">
                                    @include('ftz.components.add.documents')
                                </div>           
                            </div>
                            <div class="tab-pane fade" id="nav-pengangkut" role="tabpanel" aria-labelledby="nav-pengangkut-tab">
                                <div  class="form-group row">
                                    ...
                                    @include('ftz.ftz0101.add.partials.transport')  
                            </div>
                            <div class="tab-pane fade" id="nav-petikemas" role="tabpanel" aria-labelledby="nav-petikemas-tab">
                                                                       
                                    <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey; margin-top:10px; ">
                                        @include('ftz.components.add.kemasan')
                                    </div>
                                    <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey; margin-top:10px; ">
                                        @include('ftz.components.add.peti_kemas')
                                    </div> 
                            </div>
                                        ...
                                        <div class="col-md-4 bg-transparent border-dashed border-1  rounded p-3" style="margin-bottom:10px;">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    {!! Form::select('details[type_asuransi]', [0 => 'Dalam Negeri', 1 => 'Luar Negeri'], null, ['class' => 'form-select', 'data-control' => 'select2', 'placeholder' => '-- Select --', 'id' => 'type-asuransi']) !!}
                                ...
                                <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey;">
                                    <div class="form-group row" >
                                        <div class="col-md-12">
                                            ...
                                            @include('ftz.components.add.goods_table')
                            ...
                            <div class="tab-pane fade" id="nav-pungutan" role="tabpanel" aria-labelledby="nav-pungutan-tab">      
                                @include('ftz.ftz0101.add.partials.pungutan')
                            </div>
                        ...
                        {!! Form::close() !!}
                        @include('ftz.components.add.add_modal', ['bc' => 'FTZ0101'])
                    </div>
                    {{-- {!! Form::close() !!} --}}
                </div>
                <!--end::Card-->
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                function countHargaTranskasi(){
                    ...
                    totalCifRP              = harga_total_barang_by_kurs * Number(ndpbm.val()); 
        ...
        /*$('#destination_port_id').on('change', function(){
            ...
            $.ajax({
                type: "GET",
                url: `{{url('/')}}/master-data/port/master-kppbc/${$(this).val()}`,
                success: function(res) {
                    var result = JSON.parse(res);
                    if(result != null){
                        $('#kppbc_pengawas_id').val(`${result.code} - ${result.description}`);
                    }else {
        ...
        $('#btn-tarik-bc-satu-satu').on('click', function() { 
            ...
            if (!documentElement.length) {
                Swal.fire({
                    icon: 'error',
                    title: 'Error!',
                    text: 'Dokumen dengan kode 705 atau 107 tidak ditemukan.',
                });
                return;
            }

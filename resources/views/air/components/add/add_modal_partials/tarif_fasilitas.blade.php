<div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey;" style="margin-top: 10px;">   
    <h3 class="mb-3" style="margin-top: 10px; text-align: center;">Tarif & Fasilitas</h3>
    <hr class="mt-6 mb-6">
    <div class="form-group row">
        ...
        <div class="col-md-2">
            <div class="input-group mb-5">
            {!! Form::number('details[bm_tax_value]', 100, ['class' => 'form-control', 'required' => true, 'id' => 'bm_tax_value', 'step' => 'any',  'maxlength' => '3', 'min' => '0', 'oninput' => "if(this.value.length > this.maxLength){this.value = this.value.slice(0, this.maxLength)}
            if(this.value<0){this.value='0'}" ]) !!}
    ...
    <div class="form-group row">
        <div class="col-md-3">
            ...
            <input type="checkbox" id="show_cukai" />
        </div>
    </div>  
    <div id="cukai_1" style="display: none;">
    <div class="form-group row" >
        <div class="col-md-1">

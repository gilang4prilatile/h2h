...
<div class="form-group row" style="margin-top: 10px;">
    ...
    <div class="col-md-{{ $bc == 'BC20' ? '6' : '6' }}">
        ...
        {!! Form::select('details[uom_id]', $uoms, null, ['class' => 'form-select', 'data-control' => 'select2', 'id' => 'uom_id', 'required' => true]) !!}
    </div> 
...
<div class="form-group row" style="margin-top: 10px;">
    <div class="col-md-6">
        ...
        {!! Form::select('details[item_country]', $country, null, ['class' => 'form-select', 'data-control' => 'select2', 'placeholder' => '-- Select --' , 'id' => 'detail-country-bc30']) !!}
    </div>
    <div class="col-md-6">

...
<div class="form-group row">
    ...
    <div class="col-md-2">
        <div class="input-group mb-5">
        {!! Form::number('details[bmt]', 0, ['class' => 'form-control', 'required' => true, 'id' => 'bmt', 'step' => 'any',  'maxlength' => '3', 'min' => '0', 'oninput' => "if(this.value.length > this.maxLength){this.value = this.value.slice(0, this.maxLength)}
        if(this.value<0){this.value='0'}" ]) !!}
...
<div class="form-group row">
    ...
    <div class="col-md-3">
        <div class="input-group mb-5">
        {!! Form::number('details[ppn]', 11, ['class' => 'form-control bg-secondary', 'required' => true, 'id' => 'ppn', 'step' => 'any',  'maxlength' => '3', 'min' => '0', 'oninput' => "if(this.value.length > this.maxLength){this.value = this.value.slice(0, this.maxLength)}

...
<div class="modal fade" id="upload-pib-modal" aria-hidden="true">
    <!--begin::Modal dialog-->
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <div class="mb-13 text-center">
                    <!--begin::Title-->
                    <h1 class="mb-3">Upload Format BC</h1>
                    <!--end::Title-->
                </div>
                <!--end::Heading-->
                ...
                <div class="text-center" style="margin-top:20px;">
                    <button type="reset" id="button_cancel_modal_tambah__upload" class="btn btn-light me-3">Cancel</button>
                    <button type="submit" id="button_tambah_upload" class="btn btn-primary">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#upload-form').submit(function(e){
                ...
                $.ajax({
                    type: "POST",
                    url: `air/{{ $bc == '20' ? 'pib' : 'peb' }}/upload-all`,

            ...
            <div id="kt_content_container" class="container">
                ...
                <div class="card ">
                    <div class="card-header card-header-stretch">
                        <h3 class="card-title">Detail BC20, Nomor Pengajuan : {{$inbound->request_number}}</h3>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-header" role="tabpanel" aria-labelledby="nav-header-tab">
                                <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey; margin-top:10px; ">
                                    <div class="col-md-12">
                                        ...
                                        {!! Form::select('intangible_status', $JenisBarangTidakBerwujud, $inbound->intangible_status, ['class' => 'form-select bg-secondary', 'disabled' => true, 'required' => true, 'placeholder' => '-- Select --', 'id' => 'intangible_status',  'data-control' => 'select2']) !!}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4" style="margin-top:10px;">
                                        ...
                                        {!! Form::select('destination_port_id', [], null, ['class' => 'form-select bg-secondary', 'disabled' => true, 'data-control' => 'select2', 'placeholder' => '-- Select --', 'id' => 'destination_port_id']) !!}
                            ...
                            <div class="tab-pane fade" id="nav-dokumen" role="tabpanel" aria-labelledby="nav-dokumen-tab">
                                <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey;">                            
                                    @include('air.components.detail.documents_table')
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-pengangkut" role="tabpanel" aria-labelledby="nav-pengangkut-tab">
                                ...
                                <div  style="{{$intangible_status}}"> 
                                    @include('air.pib.detail.partials.transport')  
                                </div>
                            </div> 
                            <div class="tab-pane fade" id="nav-petikemas" role="tabpanel" aria-labelledby="nav-petikemas-tab">
                                <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey; margin-top:10px; ">
                                    @include('air.components.detail.kemasan')
                                </div>
                                <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey; margin-top:10px; ">
                                    @include('air.components.detail.peti_kemas')
                                </div>  
                            </div>
                                    ...
                                    <div class="col-md-4 bg-transparent border-dashed border-1  rounded p-3" style="margin-bottom:10px;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                {!! Form::number('details[cif_rp]', @$inbound->details['cif_rp'] ?: 0, ['class' => 'form-control bg-secondary', 'readonly' => 'readonly', 'required' => true, 'placeholder' => 'Input', 'id' => 'cif_rp',  'maxlength' => '18', 'min' => '0' , 'step' => 'any' , 'readonly', 'oninput' => "if(this.value.length > this.maxLength){this.value = this.value.slice(0, this.maxLength)}
                                                if(this.value<0){this.value='0'}" ]) !!}
                                    ...
                                    <div class="col-md-4 bg-transparent border-dashed border-1  rounded p-3" style="margin-bottom:10px;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select  class="form-control bg-secondary" name="details[type_asuransi]" id="details[type_asuransi]" data-control="select2">
                                                    <option value="" disabled selected>--Select--</option>
                                                    <option value="1" {{ ($inbound->details['type_asuransi'] ?? '') == "0" ? 'selected' : '' }}>Dalam Negeri</option>
                                                    <option value="2" {{ ($inbound->details['type_asuransi'] ?? '') == "1" ? 'selected' : '' }}>Luar Negeri</option>
                                                </select>
                            ...
                            <div class="tab-pane fade" id="nav-pungutan" role="tabpanel" aria-labelledby="nav-pungutan-tab">
                                <div class=" bg-transparent border-dashed border-1 p-3 row rounded" style="border-color:lightgrey; margin-top:10px;">
                                    @include('air.pib.detail.partials.pungutan') 
                                </div>
                            </div>
                                ...
                                <div class=" bg-light-primary border-dashed border-1  rounded p-3" style="border-color:lightgrey; margin-top:10px; ">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            {!! Form::text('details[pabean_tanggal]', @$inbound->details['pabean_tanggal'] ?: null, ['class' => 'form-control datepicker datepicker bg-secondary', 'disabled' => true, 'data-date' => @$inbound->details['pabean_tanggal'] ? \Carbon\Carbon::parse($inbound->details['pabean_tanggal'])->format('d-m-Y') : '', 'required' => true, 'placeholder' => 'Pilih Tanggal']) !!}
                            ...
                            @include('air.components.edit.edit_modal', ['bc' => 'BC20'])
                        </div>   
                    </div>
                    {{-- {!! Form::close() !!} --}}
                </div> 

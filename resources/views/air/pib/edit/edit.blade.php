                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-header" role="tabpanel" aria-labelledby="nav-header-tab">
                                <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey; margin-top:10px; ">
                                    <div class="col-md-12">
                                        ...
                                        {!! Form::select('intangible_status', $JenisBarangTidakBerwujud, $inbound->intangible_status, ['class' => 'form-select', 'required' => true, 'placeholder' => '-- Select --', 'id' => 'intangible_status',  'data-control' => 'select2']) !!}
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            {!! Form::text('details[tanggal_pendaftaran]', @$inbound->details['tanggal_pendaftaran'] ?: null, ['class' => 'form-control datepicker', 'data-date' => @$inbound->details['tanggal_pendaftaran'] ? \Carbon\Carbon::parse($inbound->details['tanggal_pendaftaran'])->format('d-m-Y') : '', 'required' => true, 'placeholder' => 'Pilih Tanggal']) !!}
                                    ...
                                    <div class="form-group row"> 
                                        <div class="col-md-4" style="margin-top:10px;">
                                            ...
                                            {!! Form::select('destination_port_id', [], null, ['class' => 'form-select', 'required' => true , 'id' => 'destination_port_id', 'placeholder' => '-- Select --', 'data-control' => 'select2']) !!}
                                ...
                                <div  class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey;">
                                    <div class="form-group row" > 
                                        ...
                                        <div class="col-md-4" style="margin-bottom:10px;">
                                            <h2 class="fw-bolder mt-4"> <label class="form-label required">NPWP Pemusatan</label></h2>
                            ...
                            <div class="tab-pane fade" id="nav-dokumen" role="tabpanel" aria-labelledby="nav-dokumen-tab">
                                <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey;">                            
                                    @include('air.components.edit.documents')
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-pengangkut" role="tabpanel" aria-labelledby="nav-pengangkut-tab">
                                ...
                                <div name="div_intangible_status" id="div_intangible_status"> 
                                    @include('air.pib.edit.partials.transport') 
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-petikemas" role="tabpanel" aria-labelledby="nav-petikemas-tab">
                                <div name="div_intangible_statuspk" id="div_intangible_statuspk" style="{{$intangible_status}}"> 
                                   <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey; margin-top:10px; ">
                                       @include('air.components.edit.kemasan')
                                   </div>
                                   <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey; margin-top:10px; ">
                                       @include('air.components.edit.peti_kemas')
                                   </div> 
                               </div>
                            </div>
                                        ...
                                        <div class="col-md-4 bg-transparent border-dashed border-1  rounded p-3" style="margin-bottom:10px;">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    {!! Form::number('details[cif_rp]', @$inbound->details['cif_rp'] ?: 0, ['class' => 'form-control bg-secondary', 'required' => true, 'placeholder' => 'Input', 'id' => 'cif_rp',  'maxlength' => '18', 'min' => '0' , 'step' => 'any' , 'readonly', 'oninput' => "if(this.value.length > this.maxLength){this.value = this.value.slice(0, this.maxLength)}
                                                    if(this.value<0){this.value='0'}" ]) !!}
                                        ...
                                        <div class="col-md-4 bg-transparent border-dashed border-1  rounded p-3" style="margin-bottom:10px;">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <select class="form-control" name="details[type_asuransi]" id="details[type_asuransi]" data-control="select2">
                                                        <option value="" disabled selected>--Select--</option>
                                                        <option value="1" {{ isset($inbound->details['type_asuransi']) && $inbound->details['type_asuransi'] == "1" ? 'selected' : '' }}>Dalam Negeri</option>
                                                        <option value="2" {{ isset($inbound->details['type_asuransi']) && $inbound->details['type_asuransi'] == "2" ? 'selected' : '' }}>Luar Negeri</option>
                                                    </select>
                                ...
                                <div class=" bg-transparent border-dashed border-1  rounded p-3" style="border-color:lightgrey;">
                                        <div class="form-group row" >
                                            <div class="col-md-12">
                                                ...
                                                <hr>
                                                @include('air.components.edit.goods_table')
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="nav-pungutan" role="tabpanel" aria-labelledby="nav-pungutan-tab">
                                @include('air.pib.edit.partials.pungutan')	
                            </div>
                                ...
                                <div class=" bg-light-primary border-dashed border-1  rounded p-3" style="border-color:lightgrey; margin-top:10px; ">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            {!! Form::text('details[pabean_tanggal]', @$inbound->details['pabean_tanggal'] ?: null, ['class' => 'form-control datepicker', 'data-date' => @$inbound->details['pabean_tanggal'] ? \Carbon\Carbon::parse($inbound->details['pabean_tanggal'])->format('d-m-Y') : '', 'required' => true, 'placeholder' => 'Pilih Tanggal']) !!}
                        ...
                        {!! Form::close() !!}
                        @include('air.components.edit.edit_modal', ['bc' => '20'])
                        @include('air.components.popup.upload_modal', ['bc' => '20','id_inbound' => $inbound->id])
                    </div>
                    {{-- {!! Form::close() !!} --}}
                </div>
                <!--end::Card-->
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            ...
            if(inbound && inbound.tujuan) { 
                var optionDestinationPort = new Option(`${inbound.tujuan.code} - ${inbound.tujuan.name}`, inbound.tujuan.id, true, true);
                $('#destination_port_id').append(optionDestinationPort).trigger("change");
            }
            ...
            document.getElementById('btn-send-draf').addEventListener('click', function() {
                Swal.fire({
                    title: 'Apakah Anda yakin?',
                    text: "Data akan disinkronkan!",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        // Menampilkan loading sebelum proses sinkronisasi
                        Swal.fire({
                        ...
                        setTimeout(() => {
                            ...
                            // Tambahkan logika sinkronisasi sesungguhnya di sini, seperti submit form atau panggilan API
                            // contoh: form.submit();
                        }, 2000);  // Simulasi waktu sinkronisasi (2 detik)
                    } else {
                        Swal.fire(
                            'Dibatalkan',

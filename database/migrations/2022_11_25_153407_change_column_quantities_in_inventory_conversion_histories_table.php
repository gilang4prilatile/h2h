...
class ChangeColumnQuantitiesInInventoryConversionHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('inventory_conversion_histories', function (Blueprint $table) {
            ...
            $table->decimal('quantity_good', 30, 10)->change();
        });
    }
    ...
    public function down()
    {
        Schema::table('inventory_conversion_histories', function (Blueprint $table) {
            ...
            $table->bigInteger('quantity_good')->change();
        });
    }
}

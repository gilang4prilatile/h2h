...
class StoreOutboundBC41Request extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'outbound_packages' => 'required|array|min:1',
            'outbound_packages.*.*' => 'required',
            'outbound_documents' => 'required|array|min:1',
            'outbound_documents.*.*' => 'required',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'outbound_packages.required' => 'the kemasan field is required',
            'outbound_packages.*.*.required' => 'the kemasan field is required',
            'outbound_documents.required' => 'the dokumen field is required',
            'outbound_documents.*.*.required' => 'the dokumen field is required',
        ];
    }
}
